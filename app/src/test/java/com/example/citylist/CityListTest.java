...
public class CityListTest {
    ...
    {
        CityList cityList=new CityList();
        City city=new City("Mymensingh","Mymensingh");
        City city1=new City("Mirpur","Dhaka");
        City city2=new City("Bonosree","Dhaka");
    ...
    /**
     * this is a test method for for checking exception.
     */
